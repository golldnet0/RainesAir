...
public class POActivity extends AppCompatActivity
    ...
    String uid, poID, poCompany, poDate, partNumber2, profilePic;
    ListView poListDateComp;
    List<String> arrayListPO = new ArrayList<>();
    List<String> arrayListPODateComp = new ArrayList<>();
    ArrayAdapter<String> adapter;
    ArrayAdapter<String> adapter1;
    private ProgressDialog mProgressDialog;
    private DatabaseReference mDatabase, mRef;
    private FirebaseUser user;
    private String poIDSel = " ";
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        try {
            ...
            welcome = (TextView) findViewById(R.id.welcomePO);

            searchView = (SearchView) findViewById(R.id.po_search);

            user = FirebaseAuth.getInstance().getCurrentUser();

            poListDateComp = (ListView) findViewById(R.id.po_list);

            adapter = new ArrayAdapter<String>(this, android.R.layout.simple_list_item_1, arrayListPODateComp);
            adapter1 = new ArrayAdapter<String>(this, android.R.layout.simple_list_item_1, arrayListPO);

            poListDateComp.setAdapter(adapter);
            ...
            mDatabase.addChildEventListener(new ChildEventListener() {
                ...
                public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                    ...
                    poID = po.getPoNum();
                    poCompany = po.getCompanyName();
                    poDate = po.getOrderDate();
                    partNumber2 = po.getPartNumber();
                    arrayListPODateComp.add(poDate + "      " + poCompany + "      " + partNumber2);
                    arrayListPO.add(poID);
            ...
            poListDateComp.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                @Override
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {

                    final Dialog dialog = new Dialog(POActivity.this);
                    dialog.setContentView(R.layout.activity_menu_po);
                    dialog.setTitle("Actions");

                    final int pos = position;

                    final Button btnView = (Button) dialog.findViewById(R.id.po_menu_view);

                    btnView.setOnClickListener(new View.OnClickListener() {

                        public void onClick(View v) {

                            poIDSel = String.valueOf(arrayListPO.get(pos));

                            intent = new Intent(getApplicationContext(), POViewDetailsActivity.class);
                            intent.putExtra("poID", poIDSel);
                            startActivity(intent);
                        }
                    });

                    final Button btnDelete = (Button) dialog.findViewById(R.id.po_menu_delete);
                    btnDelete.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            // Add the buttons
                            builder
                                    .setMessage("Are you sure you want to delete this PO from the system?")
                                    .setCancelable(false)
                    ...
                    final Button btnPayment = (Button) dialog.findViewById(R.id.po_menu_payment);
            ...
            addPO = (Button) findViewById(R.id.po_add);

            addPO.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {

                    intent = new Intent(getApplicationContext(), POAddActivity.class);
                    startActivity(intent);
                }
            });
            ...
            pic = (ImageView) findViewById(R.id.imageViewPO);
    ...
    private void deletePO(String idForPO) {
        ...
        try {
            ...
            mDatabase = FirebaseDatabase.getInstance().getReference().child(uid).child("PO");
            mDatabase.child(idForPO).removeValue();
