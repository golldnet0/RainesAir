...
public class PartsActivity extends AppCompatActivity
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        try {
            ...
            welcome = (TextView) findViewById(R.id.welcomeParts);

            searchView = (SearchView) findViewById(R.id.parts_search);

            user = FirebaseAuth.getInstance().getCurrentUser();

            partsList = (ListView) findViewById(R.id.part_list);

            adapter = new ArrayAdapter<String>(this, android.R.layout.simple_list_item_1, arrayListParts);
            adapter1 = new ArrayAdapter<String>(this, android.R.layout.simple_list_item_1, arrayListPartID);
            ...
            mDatabase.addChildEventListener(new ChildEventListener() {
                ...
                public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                    ...
                    String partNameList = part.getPartNumber();
                    arrayListParts.add(partNameList);
                    arrayListPartID.add(partID);
            ...
            partsList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    final Dialog dialog = new Dialog(PartsActivity.this);
                    dialog.setContentView(R.layout.activity_menu_part);
                    dialog.setTitle("Actions");

                    final int pos = position;

                    final Button btnView = (Button) dialog.findViewById(R.id.part_menu_view);

                    btnView.setOnClickListener(new View.OnClickListener() {

                        public void onClick(View v) {

                            partIDSel = String.valueOf(arrayListPartID.get(pos));

                            intent = new Intent(getApplicationContext(), PartsViewDetailsActivity.class);
                            intent.putExtra("partID", partIDSel);
                    ...
                    final Button btnDelete = (Button) dialog.findViewById(R.id.part_menu_delete);
                    btnDelete.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            // Add the buttons
                            builder
                                    .setMessage("Are you sure you want to delete this part from the system?")
                                    .setCancelable(false)
            ...
            addPart = (Button) findViewById(R.id.parts_add);

            addPart.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {

                    intent = new Intent(getApplicationContext(), PartsAddActivity.class);
                    startActivity(intent);
                }
            });
            ...
            pic = (ImageView) findViewById(R.id.imageViewParts);
    ...
    private void deletePart(String idForPart) {


        try {
            mProgressDialog.setMessage("Removing Part..");
            mProgressDialog.show();

            mDatabase = FirebaseDatabase.getInstance().getReference().child(uid).child("Parts").child(idForPart);
