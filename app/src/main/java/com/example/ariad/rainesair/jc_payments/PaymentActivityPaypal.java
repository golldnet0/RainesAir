...
public class PaymentActivityPaypal extends AppCompatActivity implements View.OnClickListener {

    private Button buttonPay;
    private EditText editTextAmount;
    private ImageView amountAdd_back;
    Intent intent;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        amountAdd_back = (ImageView) findViewById(R.id.amountAdd_back);

        amountAdd_back.setOnClickListener(new View.OnClickListener() {
        ...
        if (editTextAmount == null) {
            ...
            Toast.makeText(getApplicationContext(), "Please enter an amount to pay", Toast.LENGTH_SHORT).show();
        } else {
